...
const translations: Record<Locale, Record<string, string>> = {
  IT: {
    ...
    'common.close': 'Chiudi',
    'sample.item.name': 'Maglietta',
    'sample.item.category': 'Maglietta',
    'sample.item.color': 'Nero',
  ...
  EN: {
    ...
    'common.close': 'Close',
    'sample.item.name': 'T-Shirt',
    'sample.item.category': 'T-Shirt',
    'sample.item.color': 'Black',
  ...
  JA: {
    ...
    'common.close': '閉じる',
    'sample.item.name': 'Tシャツ',
    'sample.item.category': 'Tシャツ',
    'sample.item.color': '黒',
  ...
  RU: {
    ...
    'sample.item.name': 'Футболка',
    'sample.item.category': 'Футболка',
    'sample.item.color': 'Чёрный',
